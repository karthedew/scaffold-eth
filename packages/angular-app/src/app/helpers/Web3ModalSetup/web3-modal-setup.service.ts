...
// import { EthersProvider } from "./web3-modal-setup.injectable";
...
export class Web3ModalSetupService {

  public web3ModalSetup: Web3Modal;

  constructor() {
    this.web3ModalSetup = new Web3Modal({
